...
public class Batterie extends AbstractComponent implements IUniteProduction, IProduction {
	...
	public Batterie(String reflectionInboundPortURI, int nbThreads, int nbSchedulableThreads, String dataOutPortURI) throws Exception {
